...
void summatixcolsinarry(int arr[3][3],int arrsums[3],short rows,short cols)
{
    for(short j=0;j<cols;j++)
    {
       arrsums[j]=colsum(arr,rows,j);
    }
}

void printcolumnsums(int arr[3],short length)
{
...
int main()
{
    ...
    printmatrix(arr,3,3);
    summatixcolsinarry(arr,arrsums,3,3);
    printcolumnsums(arrsums,3);
